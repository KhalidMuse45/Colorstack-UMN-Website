...
export const board: BoardMember[] = [
  ...
  { id: 'arsema', name: 'Arsema', role: 'Secretary', bio: 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', src: '/images/board/board-arsema.webp', alt: 'Portrait of Arsema', width: 800, height: 800, accent: 'maroon' },
  { id: 'hangatu', name: 'Hangatu', role: 'Event Coordinator', bio: 'Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea.', src: '/images/board/board-hangatu.webp', alt: 'Portrait of Hangatu', width: 800, height: 800, accent: 'gold' },
  { id: 'kananisa', name: 'Kananisa', role: 'Vice President', bio: 'Duis aute irure dolor in reprehenderit in voluptate velit.', src: '/images/board/board-kananisa.webp', alt: 'Portrait of Kananisa', width: 800, height: 800, accent: 'rose' },
  { id: 'khalid-muse', name: 'Khalid Muse', role: 'President', bio: 'Ut enim ad minim veniam, quis nostrud exercitation ullamco.', src: '/images/board/board-khalid-muse.webp', alt: 'Portrait of Khalid Muse', width: 1600, height: 1600, accent: 'teal' },
  ...
  { id: 'rahma', name: 'Rahma', role: 'Public Relations', bio: 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui.', src: '/images/board/board-rahma.webp', alt: 'Portrait of Rahma', width: 1600, height: 1600, accent: 'maroon' },
  { id: 'salah', name: 'Salaahudiin', role: 'Outreach', bio: 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem.', src: '/images/board/board-salah.webp', alt: 'Portrait of Salah', width: 800, height: 800, accent: 'gold' },
  ...
  { id: 'salwa', name: 'Salwa', role: 'Outreach', bio: 'Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.', src: '/images/board/board-salwa.webp', alt: 'Portrait of Salwa', width: 800, height: 800, accent: 'teal' },
  ...
  { id: 'selamawit', name: 'Selam', role: 'Event Coordinator', bio: 'At vero eos et accusamus et iusto odio dignissimos ducimus.', src: '/images/board/board-selamawit.webp', alt: 'Portrait of Selamawit', width: 800, height: 800, accent: 'maroon' },
];
